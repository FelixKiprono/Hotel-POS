...
namespace Hotel_POS
{
    public partial class OrderReport : Form
    {
        ...
        private void LoadReport()
        {
            ...
            try
            {
                String SQL = "SELECT `OrderNumber`, `Date`, `Status`, `Total`, `Waiter` FROM `orders` WHERE 1";
                ...
                html.AppendLine("<p>");
                html.AppendLine("</p>");
                html.AppendLine("<table border='1'><tr><th><center><h2>ORDERS REPORT<h2></center></th> </tr> </table> ");
                ...
                html.AppendLine("<tr>");
                html.AppendLine("<th>No.</th><th>OrderNumber</th><th>Date</th><th>Status</th><th>Waiter</th><th>Total</th>");
                html.AppendLine("<tr>");
                int i = 0;
                while (read.Read())
                {
